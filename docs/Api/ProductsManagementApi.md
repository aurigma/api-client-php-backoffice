...
| [**productsManagementSetProductImage()**](ProductsManagementApi.md#productsManagementSetProductImage) | **POST** /api/backoffice/v1/products/{id}/set-image | Set a thumbnail image for an existing product. |
| [**productsManagementSetProductOptions()**](ProductsManagementApi.md#productsManagementSetProductOptions) | **PUT** /api/backoffice/v1/products/{id}/options | Set product options and returns updated options list. |
...
| [**productsManagementSetProductVariantWeight()**](ProductsManagementApi.md#productsManagementSetProductVariantWeight) | **POST** /api/backoffice/v1/products/{id}/set-variant-weight | Set product variants weight. Variants identifiers will be changed. |
| [**productsManagementUpdateProductVariantResources()**](ProductsManagementApi.md#productsManagementUpdateProductVariantResources) | **POST** /api/backoffice/v1/products/{id}/update-variant-resources | Updates product variant resources. |
| [**productsManagementValidateProductVariantResources()**](ProductsManagementApi.md#productsManagementValidateProductVariantResources) | **POST** /api/backoffice/v1/products/{id}/validate-variant-resources | Validates product variant resources. |


## `productsManagementCreateDesignsConnections()`

```php
productsManagementCreateDesignsConnections($id, $tenant_id, $products_management_create_designs_connections_request)
```
...
$products_management_create_designs_connections_request = new \Aurigma\BackOffice\Model\ProductsManagementCreateDesignsConnectionsRequest(); // \Aurigma\BackOffice\Model\ProductsManagementCreateDesignsConnectionsRequest | Product designs connections creation parameters.

try {
    $apiInstance->productsManagementCreateDesignsConnections($id, $tenant_id, $products_management_create_designs_connections_request);
} catch (Exception $e) {
...
| **products_management_create_designs_connections_request** | [**\Aurigma\BackOffice\Model\ProductsManagementCreateDesignsConnectionsRequest**](../Model/ProductsManagementCreateDesignsConnectionsRequest.md)| Product designs connections creation parameters. | [optional] |
...
```php
productsManagementCreateDocumentsConnections($id, $tenant_id, $products_management_create_documents_connections_request)
```
...
$id = 56; // int | Product identifier.
$tenant_id = 56; // int | Tenant identifier.
$products_management_create_documents_connections_request = new \Aurigma\BackOffice\Model\ProductsManagementCreateDocumentsConnectionsRequest(); // \Aurigma\BackOffice\Model\ProductsManagementCreateDocumentsConnectionsRequest | Product documents connections creation parameters.

try {
    $apiInstance->productsManagementCreateDocumentsConnections($id, $tenant_id, $products_management_create_documents_connections_request);
} catch (Exception $e) {
...
| **id** | **int**| Product identifier. | |
| **tenant_id** | **int**| Tenant identifier. | [optional] |
| **products_management_create_documents_connections_request** | [**\Aurigma\BackOffice\Model\ProductsManagementCreateDocumentsConnectionsRequest**](../Model/ProductsManagementCreateDocumentsConnectionsRequest.md)| Product documents connections creation parameters. | [optional] |
...
```php
productsManagementCreateMockupsConnections($id, $tenant_id, $products_management_create_mockups_connections_request)
```
...
$id = 56; // int | Product identifier.
$tenant_id = 56; // int | Tenant identifier.
$products_management_create_mockups_connections_request = new \Aurigma\BackOffice\Model\ProductsManagementCreateMockupsConnectionsRequest(); // \Aurigma\BackOffice\Model\ProductsManagementCreateMockupsConnectionsRequest | Product mockups connections creation parameters.

try {
    $apiInstance->productsManagementCreateMockupsConnections($id, $tenant_id, $products_management_create_mockups_connections_request);
} catch (Exception $e) {
...
| **id** | **int**| Product identifier. | |
| **tenant_id** | **int**| Tenant identifier. | [optional] |
| **products_management_create_mockups_connections_request** | [**\Aurigma\BackOffice\Model\ProductsManagementCreateMockupsConnectionsRequest**](../Model/ProductsManagementCreateMockupsConnectionsRequest.md)| Product mockups connections creation parameters. | [optional] |
...
```php
productsManagementCreateProduct($tenant_id, $products_management_create_product_request): \Aurigma\BackOffice\Model\ProductDto
```
...
$tenant_id = 56; // int | Tenant identifier.
$products_management_create_product_request = new \Aurigma\BackOffice\Model\ProductsManagementCreateProductRequest(); // \Aurigma\BackOffice\Model\ProductsManagementCreateProductRequest | Product creation parameters.

try {
    $result = $apiInstance->productsManagementCreateProduct($tenant_id, $products_management_create_product_request);
    print_r($result);
} catch (Exception $e) {
...
| ------------- | ------------- | ------------- | ------------- |
| **tenant_id** | **int**| Tenant identifier. | [optional] |
| **products_management_create_product_request** | [**\Aurigma\BackOffice\Model\ProductsManagementCreateProductRequest**](../Model/ProductsManagementCreateProductRequest.md)| Product creation parameters. | [optional] |
...
```php
productsManagementRemoveDesignsConnections($id, $tenant_id, $products_management_remove_designs_connections_request)
```
...
$id = 56; // int | Product identifier.
$tenant_id = 56; // int | Tenant identifier.
$products_management_remove_designs_connections_request = new \Aurigma\BackOffice\Model\ProductsManagementRemoveDesignsConnectionsRequest(); // \Aurigma\BackOffice\Model\ProductsManagementRemoveDesignsConnectionsRequest | Product designs connections creation parameters.

try {
    $apiInstance->productsManagementRemoveDesignsConnections($id, $tenant_id, $products_management_remove_designs_connections_request);
} catch (Exception $e) {
...
| **id** | **int**| Product identifier. | |
| **tenant_id** | **int**| Tenant identifier. | [optional] |
| **products_management_remove_designs_connections_request** | [**\Aurigma\BackOffice\Model\ProductsManagementRemoveDesignsConnectionsRequest**](../Model/ProductsManagementRemoveDesignsConnectionsRequest.md)| Product designs connections creation parameters. | [optional] |
...
```php
productsManagementRemoveDocumentsConnections($id, $tenant_id, $products_management_remove_documents_connections_request)
```
...
$id = 56; // int | Product identifier.
$tenant_id = 56; // int | Tenant identifier.
$products_management_remove_documents_connections_request = new \Aurigma\BackOffice\Model\ProductsManagementRemoveDocumentsConnectionsRequest(); // \Aurigma\BackOffice\Model\ProductsManagementRemoveDocumentsConnectionsRequest | Product documents connections creation parameters.

try {
    $apiInstance->productsManagementRemoveDocumentsConnections($id, $tenant_id, $products_management_remove_documents_connections_request);
} catch (Exception $e) {
...
| **id** | **int**| Product identifier. | |
| **tenant_id** | **int**| Tenant identifier. | [optional] |
| **products_management_remove_documents_connections_request** | [**\Aurigma\BackOffice\Model\ProductsManagementRemoveDocumentsConnectionsRequest**](../Model/ProductsManagementRemoveDocumentsConnectionsRequest.md)| Product documents connections creation parameters. | [optional] |
...
```php
productsManagementRemoveMockupsConnections($id, $tenant_id, $products_management_remove_mockups_connections_request)
```
...
$id = 56; // int | Product identifier.
$tenant_id = 56; // int | Tenant identifier.
$products_management_remove_mockups_connections_request = new \Aurigma\BackOffice\Model\ProductsManagementRemoveMockupsConnectionsRequest(); // \Aurigma\BackOffice\Model\ProductsManagementRemoveMockupsConnectionsRequest | Product mockups connections creation parameters.

try {
    $apiInstance->productsManagementRemoveMockupsConnections($id, $tenant_id, $products_management_remove_mockups_connections_request);
} catch (Exception $e) {
...
| **id** | **int**| Product identifier. | |
| **tenant_id** | **int**| Tenant identifier. | [optional] |
| **products_management_remove_mockups_connections_request** | [**\Aurigma\BackOffice\Model\ProductsManagementRemoveMockupsConnectionsRequest**](../Model/ProductsManagementRemoveMockupsConnectionsRequest.md)| Product mockups connections creation parameters. | [optional] |
...
## `productsManagementSetProductImage()`

```php
productsManagementSetProductImage($id, $product_version_id, $tenant_id, $file)
```
...
$tenant_id = 56; // int | Tenant identifier.
$file = "/path/to/file.txt"; // \SplFileObject | Product thumbnail image file.

try {
    $apiInstance->productsManagementSetProductImage($id, $product_version_id, $tenant_id, $file);
} catch (Exception $e) {
    echo 'Exception when calling ProductsManagementApi->productsManagementSetProductImage: ', $e->getMessage(), PHP_EOL;
}
```
...
| **tenant_id** | **int**| Tenant identifier. | [optional] |
| **file** | **\SplFileObject****\SplFileObject**| Product thumbnail image file. | [optional] |
...
## `productsManagementSetProductOptions()`

```php
productsManagementSetProductOptions($id, $tenant_id, $products_management_set_product_options_request): \Aurigma\BackOffice\Model\PagedOfProductOptionDto
```
...
$id = 56; // int | Product identifier.
$tenant_id = 56; // int | Tenant identifier.
$products_management_set_product_options_request = new \Aurigma\BackOffice\Model\ProductsManagementSetProductOptionsRequest(); // \Aurigma\BackOffice\Model\ProductsManagementSetProductOptionsRequest

try {
    $result = $apiInstance->productsManagementSetProductOptions($id, $tenant_id, $products_management_set_product_options_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ProductsManagementApi->productsManagementSetProductOptions: ', $e->getMessage(), PHP_EOL;
}
```
...
| **id** | **int**| Product identifier. | |
| **tenant_id** | **int**| Tenant identifier. | [optional] |
| **products_management_set_product_options_request** | [**\Aurigma\BackOffice\Model\ProductsManagementSetProductOptionsRequest**](../Model/ProductsManagementSetProductOptionsRequest.md)|  | [optional] |
...
```php
productsManagementSetProductVariantAvailability($id, $tenant_id, $products_management_set_product_variant_availability_request)
```
...
$id = 56; // int | Product identifier.
$tenant_id = 56; // int | Tenant identifier.
$products_management_set_product_variant_availability_request = new \Aurigma\BackOffice\Model\ProductsManagementSetProductVariantAvailabilityRequest(); // \Aurigma\BackOffice\Model\ProductsManagementSetProductVariantAvailabilityRequest | Set product variants availability operation parameters.

try {
    $apiInstance->productsManagementSetProductVariantAvailability($id, $tenant_id, $products_management_set_product_variant_availability_request);
} catch (Exception $e) {
...
| **id** | **int**| Product identifier. | |
| **tenant_id** | **int**| Tenant identifier. | [optional] |
| **products_management_set_product_variant_availability_request** | [**\Aurigma\BackOffice\Model\ProductsManagementSetProductVariantAvailabilityRequest**](../Model/ProductsManagementSetProductVariantAvailabilityRequest.md)| Set product variants availability operation parameters. | [optional] |
...
```php
productsManagementSetProductVariantPrice($id, $tenant_id, $products_management_set_product_variant_price_request)
```
...
$id = 56; // int | Product identifier.
$tenant_id = 56; // int | Tenant identifier.
$products_management_set_product_variant_price_request = new \Aurigma\BackOffice\Model\ProductsManagementSetProductVariantPriceRequest(); // \Aurigma\BackOffice\Model\ProductsManagementSetProductVariantPriceRequest | Set product variants price operation parameters.

try {
    $apiInstance->productsManagementSetProductVariantPrice($id, $tenant_id, $products_management_set_product_variant_price_request);
} catch (Exception $e) {
...
| **id** | **int**| Product identifier. | |
| **tenant_id** | **int**| Tenant identifier. | [optional] |
| **products_management_set_product_variant_price_request** | [**\Aurigma\BackOffice\Model\ProductsManagementSetProductVariantPriceRequest**](../Model/ProductsManagementSetProductVariantPriceRequest.md)| Set product variants price operation parameters. | [optional] |
...
```php
productsManagementSetProductVariantSku($id, $tenant_id, $products_management_set_product_variant_sku_request)
```
...
$id = 56; // int | Product identifier.
$tenant_id = 56; // int | Tenant identifier.
$products_management_set_product_variant_sku_request = new \Aurigma\BackOffice\Model\ProductsManagementSetProductVariantSkuRequest(); // \Aurigma\BackOffice\Model\ProductsManagementSetProductVariantSkuRequest | Set product variants SKU operation parameters.

try {
    $apiInstance->productsManagementSetProductVariantSku($id, $tenant_id, $products_management_set_product_variant_sku_request);
} catch (Exception $e) {
...
| **id** | **int**| Product identifier. | |
| **tenant_id** | **int**| Tenant identifier. | [optional] |
| **products_management_set_product_variant_sku_request** | [**\Aurigma\BackOffice\Model\ProductsManagementSetProductVariantSkuRequest**](../Model/ProductsManagementSetProductVariantSkuRequest.md)| Set product variants SKU operation parameters. | [optional] |
...
## `productsManagementSetProductVariantWeight()`

```php
productsManagementSetProductVariantWeight($id, $tenant_id, $products_management_set_product_variant_weight_request)
```
...
$id = 56; // int | Product identifier.
$tenant_id = 56; // int | Tenant identifier.
$products_management_set_product_variant_weight_request = new \Aurigma\BackOffice\Model\ProductsManagementSetProductVariantWeightRequest(); // \Aurigma\BackOffice\Model\ProductsManagementSetProductVariantWeightRequest | Set product variants weight operation parameters.

try {
    $apiInstance->productsManagementSetProductVariantWeight($id, $tenant_id, $products_management_set_product_variant_weight_request);
} catch (Exception $e) {
    echo 'Exception when calling ProductsManagementApi->productsManagementSetProductVariantWeight: ', $e->getMessage(), PHP_EOL;
}
```
...
| **id** | **int**| Product identifier. | |
| **tenant_id** | **int**| Tenant identifier. | [optional] |
| **products_management_set_product_variant_weight_request** | [**\Aurigma\BackOffice\Model\ProductsManagementSetProductVariantWeightRequest**](../Model/ProductsManagementSetProductVariantWeightRequest.md)| Set product variants weight operation parameters. | [optional] |
...
## `productsManagementUpdateProductVariantResources()`

```php
productsManagementUpdateProductVariantResources($id, $product_version_id, $tenant_id)
```
...
try {
    $apiInstance->productsManagementUpdateProductVariantResources($id, $product_version_id, $tenant_id);
} catch (Exception $e) {
    echo 'Exception when calling ProductsManagementApi->productsManagementUpdateProductVariantResources: ', $e->getMessage(), PHP_EOL;
}
```
...
## `productsManagementValidateProductVariantResources()`

```php
productsManagementValidateProductVariantResources($id, $tenant_id)
```
...
try {
    $apiInstance->productsManagementValidateProductVariantResources($id, $tenant_id);
} catch (Exception $e) {
    echo 'Exception when calling ProductsManagementApi->productsManagementValidateProductVariantResources: ', $e->getMessage(), PHP_EOL;
}
```
