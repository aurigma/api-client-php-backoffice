...
| **storefronts_management_create_big_commerce_storefront_request** | [**\Aurigma\BackOffice\Model\StorefrontsManagementCreateBigCommerceStorefrontRequest**](../Model/StorefrontsManagementCreateBigCommerceStorefrontRequest.md)| BigCommerce storefront creation model. | [optional] |
...
| ------------- | ------------- | ------------- | ------------- |
| **tenant_id** | **int**| Tenant identifier. | [optional] |
| **storefronts_management_create_custom_storefront_request** | [**\Aurigma\BackOffice\Model\StorefrontsManagementCreateCustomStorefrontRequest**](../Model/StorefrontsManagementCreateCustomStorefrontRequest.md)| Custom storefront creation model. | [optional] |
...
| ------------- | ------------- | ------------- | ------------- |
| **tenant_id** | **int**| Tenant identifier. | [optional] |
| **storefronts_management_create_magento_storefront_request** | [**\Aurigma\BackOffice\Model\StorefrontsManagementCreateMagentoStorefrontRequest**](../Model/StorefrontsManagementCreateMagentoStorefrontRequest.md)| Magento storefront creation model. | [optional] |
...
| ------------- | ------------- | ------------- | ------------- |
| **tenant_id** | **int**| Tenant identifier. | [optional] |
| **storefronts_management_create_nop_commerce_storefront_request** | [**\Aurigma\BackOffice\Model\StorefrontsManagementCreateNopCommerceStorefrontRequest**](../Model/StorefrontsManagementCreateNopCommerceStorefrontRequest.md)| NopCommerce storefront creation model. | [optional] |
...
| ------------- | ------------- | ------------- | ------------- |
| **tenant_id** | **int**| Tenant identifier. | [optional] |
| **storefronts_management_create_woo_commerce_storefront_request** | [**\Aurigma\BackOffice\Model\StorefrontsManagementCreateWooCommerceStorefrontRequest**](../Model/StorefrontsManagementCreateWooCommerceStorefrontRequest.md)| WooCommerce storefront creation model. | [optional] |
...
```php
storefrontsManagementGetAll($types, $skip, $take, $sorting, $search, $status, $tenant_id): \Aurigma\BackOffice\Model\PagedOfStorefrontDto
```
...
$status = new \Aurigma\BackOffice\Model\\Aurigma\BackOffice\Model\StorefrontStatus(); // \Aurigma\BackOffice\Model\StorefrontStatus | Storefront status.
$tenant_id = 56; // int | Tenant identifier.

try {
    $result = $apiInstance->storefrontsManagementGetAll($types, $skip, $take, $sorting, $search, $status, $tenant_id);
    print_r($result);
} catch (Exception $e) {
...
| **status** | [**\Aurigma\BackOffice\Model\StorefrontStatus**](../Model/.md)| Storefront status. | [optional] |
| **tenant_id** | **int**| Tenant identifier. | [optional] |
