...
**mockup_type** | [**\Aurigma\BackOffice\Model\ProductVariantMockupType**](ProductVariantMockupType.md) | Mockup type. | [optional]
**surface_index** | **int** | Surface index indicates a surface of a design to which mockup should be applied. | [optional]
**surface_usage_type** | [**\Aurigma\BackOffice\Model\SurfaceUsageType**](SurfaceUsageType.md) | Surface usage type defines a scheme for applying mockup to design surfaces. | [optional]
