...
------------ | ------------- | ------------- | -------------
**settings** | [**\Aurigma\BackOffice\Model\NopCommerceStorefrontDtoSettings**](NopCommerceStorefrontDtoSettings.md) |  | [optional]
...
**type** | [**\Aurigma\BackOffice\Model\StorefrontType**](StorefrontType.md) | Storefront ecommerce system type. | [optional]
