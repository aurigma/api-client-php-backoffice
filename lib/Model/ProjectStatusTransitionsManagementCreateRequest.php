...
/**
 * ProjectStatusTransitionsManagementCreateRequest Class Doc Comment
 *
 * @category Class
 * @description Status transition creation parameters.
 * @package  Aurigma\BackOffice
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ProjectStatusTransitionsManagementCreateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProjectStatusTransitionsManagement_Create_request';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('start_status', $data ?? [], null);
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name Transition hidden system name.
     *
     * @return self
     */
    ...
    {
        if (is_null($start_status)) {
            throw new \InvalidArgumentException('non-nullable start_status cannot be null');
        }
