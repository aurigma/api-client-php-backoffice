...
/**
 * CreateProjectStatusTransitionDto Class Doc Comment
 *
 * @category Class
 * @description Project status transition creation parameters.
 * @package  Aurigma\BackOffice
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CreateProjectStatusTransitionDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateProjectStatusTransitionDto';
