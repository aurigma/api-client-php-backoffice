...
/**
 * ProjectStatusesManagementCreateRequest Class Doc Comment
 *
 * @category Class
 * @description Status creation parameters.
 * @package  Aurigma\BackOffice
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ProjectStatusesManagementCreateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProjectStatusesManagement_Create_request';
    ...
    */
     ...
     * Sets color
     *
     * @param string|null $color Status mark color.
     *
     * @return self
     */
     ...
     * Sets is_initial
     *
     * @param bool|null $is_initial Indicates if status is initial for all projects. Only one status may be used as initial.
     *
     * @return self
     */
     ...
     * Sets is_final
     *
     * @param bool|null $is_final Indicates if status is final. Multiple statuses may be used as final (e.g. Completed, Rejected etc).
     *
     * @return self
     */
