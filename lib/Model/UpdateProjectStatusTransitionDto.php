...
/**
 * UpdateProjectStatusTransitionDto Class Doc Comment
 *
 * @category Class
 * @description Project status transition update parameters.
 * @package  Aurigma\BackOffice
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class UpdateProjectStatusTransitionDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateProjectStatusTransitionDto';
