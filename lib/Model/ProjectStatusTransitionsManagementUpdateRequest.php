...
/**
 * ProjectStatusTransitionsManagementUpdateRequest Class Doc Comment
 *
 * @category Class
 * @description Status transition update parameters.
 * @package  Aurigma\BackOffice
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ProjectStatusTransitionsManagementUpdateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProjectStatusTransitionsManagement_Update_request';
