...
/**
 * ProjectStatusTransitionDto Class Doc Comment
 *
 * @category Class
 * @description Project status transition dto class.
 * @package  Aurigma\BackOffice
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ProjectStatusTransitionDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProjectStatusTransitionDto';
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id Transition identifier.
     *
     * @return self
     */
